...
public class AdminUnitWebService {
    ...
    public ServiceResponse getCompanyUnitList(AdminEditObject adminEditObject) {
        ...
        try {
            checkAuthority = new CheckAdminAuthority(adminEditObject.getClientID()
                    , adminEditObject.getCompanyID());
            if (checkAuthority.isUserCompanyAuthorized()) {
    ...
    public ServiceResponse insertNewUnit(Units unit) {
        serviceResponse = new ServiceResponse();
        try {
            checkAuthority = new CheckAdminAuthority(unit.getClientID(), unit.getCompanyID());
