package com.alomonshi.bussinesslayer.accesscheck.webrequestaccesscheck.authorization;
...
public class Authorization {
    ...
    public boolean isNotWebTokenBelongedToRequestedUser(int clientIDGotFromRequestBody) {
        return clientIDGotFromRequestBody != user.getClientID();
    }
